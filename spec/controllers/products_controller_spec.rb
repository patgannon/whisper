...
describe ProductsController do
  ...
  def mock_products
    @mock_products ||= pageable(mock_product)
  end
  ...
  describe "GET index" do
    it "assigns all products as @products" do
      get :index
      assigns(:products).should eq(mock_products)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns the new product to the current project" do
        Product.stub(:new).with({'these' => 'params'}) { mock_product(:save => true) }
        mock_product.should_receive(:project=).with(mock_project)
        post :create, :product => {'these' => 'params'}
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved product as @product" do
        Product.stub(:new).with({'these' => 'params'}) { mock_product(save_should_fail) }
        post :create, :product => {'these' => 'params'}
        assigns(:product).should be(mock_product)
      end

      it "re-renders the 'new' template" do
        Product.stub(:new) { mock_product(save_should_fail) }
        post :create, :product => {}
  ...
  describe "PUT update" do
    ...
    describe "with invalid params" do
      it "assigns the product as @product" do
        Product.stub(:find) { mock_product(update_should_fail) }
        put :update, :id => "1"
        assigns(:product).should be(mock_product)
      end
